...
A Yandex E-mail is created for registering a Twitter account for crawling.

### Yandex E-mail Information

- E-mail address: `gleap-dev@yandex.com`
- First name: `Developer`
- Last name: `G-LEAP`
- Login: gleap-dev
- Password: `emojiprediction!`
- Security question (your favourite musician's surname): `Robert`

### Twitter Account Information

- Account: `@gleap_developer`
- Name: `Developer`
- E-mail: `gleap-dev@yandex.com`
